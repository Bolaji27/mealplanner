...
function RightPage() {
  return (
    <div className="xl:w-full lg:w-full md:w-full sm:w-full xl:flex xl:flex-col lg:flex-col sm:block md:block hidden sm:mt-8">
      <h1 className="font-frank text-black text-center text-[32px] xl:w-[686px] md:w-full md:mt-12 xl:block lg:block md:block sm:mb-4 xl:mt-0">
        Meal Family Planner
      </h1>
      <Image
        src={meal}
        alt="meal-ad"
        className=" xl:mt-10 lg:mt-6 xl:ml-[196px] lg:m-auto md:w-[348px] md:h-[207px] md:mt-10 md:m-auto xl:block lg:block md:block sm:w-[240px] sm:m-auto "
      />
      ...
      <h1 className="border-b text-center text-[32px] font-gravitas border-b-black text-black xl:mt-6 xl:ml-[98px] lg:mt-4 md:hidden sm:hidden">
        Food for thought
      </h1>
